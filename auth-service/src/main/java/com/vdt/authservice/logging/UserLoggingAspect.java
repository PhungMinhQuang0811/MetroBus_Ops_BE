...
public class UserLoggingAspect {
    ...
    // --- REGISTER ---
    @Pointcut("execution(* com.vdt.authservice.service.UserService.register(..))")
    ...
    // --- VERIFY REGISTRATION ---
    @Pointcut("execution(* com.vdt.authservice.service.UserService.verifyRegistration(..))")
    ...
    @Pointcut("execution(* com.vdt.authservice.service.UserService.resendVerificationEmail(..))")
