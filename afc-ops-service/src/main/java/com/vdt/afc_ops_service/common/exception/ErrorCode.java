...
public enum ErrorCode {
    ...
    TICKET_NOT_FOUND(3034, "Ticket not found", HttpStatus.NOT_FOUND),
    TICKET_EXPIRED(3035, "Ticket already expired", HttpStatus.BAD_REQUEST),
    TICKET_ALREADY_USED(3036, "Ticket already used", HttpStatus.BAD_REQUEST),
    TICKET_INVALID(3037, "Ticket is invalid", HttpStatus.BAD_REQUEST),
