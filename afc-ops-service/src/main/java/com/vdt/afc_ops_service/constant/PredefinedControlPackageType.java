...
public final class PredefinedControlPackageType {
    ...
    public static final String STATION_CONTEXT = "STATION_CONTEXT";
    public static final String MEDIA_ACCESS_RULES = "MEDIA_ACCESS_RULES";

    public static boolean isValid(String value) {
        return DEVICE_CONFIG.equals(value) || STATION_CONTEXT.equals(value) || MEDIA_ACCESS_RULES.equals(value);
    }
