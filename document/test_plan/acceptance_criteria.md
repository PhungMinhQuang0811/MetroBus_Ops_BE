...
- [ ] **AC-UC01-04 [P0]** Given hành khách đặt mật khẩu thành công sau khi xác minh OTP đăng ký, then hệ thống tạo `accounts` với role `PASSENGER`, không tạo ví `PASSENGER`, cấp JWT và đăng nhập thành công.
